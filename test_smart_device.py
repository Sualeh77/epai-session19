...
def test_multiple_devices():
    ...
    assert SmartDevice.device_count == 13 # Changed it to 13 because i have kept it as class attribute to count instances created of the class. and in above code it has been intiated 13 times.
